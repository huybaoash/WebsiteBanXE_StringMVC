...
<c:choose>
	...
	<div class="container tt">
		...
		<form action = "carconmany-edit.htm" method="post" enctype='multipart/form-data'>
		...
		<div class="form-horizontal">
		    ...
		    <div class="form-group">
		        <input style="display:none;" id = "MAHSX" name ="MAHSX" value ="${hsx.getMAHSX()}"/>
		        <div class="col-md-10">
		            <label for="TENHSX">Tên hãng</label>
            		<input required  id = "TENHSX" name ="TENHSX" class = "form-control" Type = "text" placeholder = "Vd: Honda" value ="${hsx.getTENHSX()}"/>
		        </div>
		    ...
		    <div>
		        <div>
		            ...
		            <a href="/WebBanXE/carconmpany-list-admin" class="btn btn-primary"> Trở lại danh sách </a>
		        </div>
		    </div>
		</div>
		</form>
